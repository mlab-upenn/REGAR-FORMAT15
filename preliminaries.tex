...
\hatodoin{Let $\varphi$ be a requirement on $M$ expressed in ACTL$^*$, and $\absfun$ be an abstraction function. The model $\absfun(M)$ is \emph{appropriate} for the requirement $\varphi$ if 
