...
\subsubsection{Requirement Encoding}
...
\begin{figure}[!t]
	...
	\label{fig:CE}
\end{figure}
\subsubsection{Providing Unambiguous Counter-examples to the Physicians}
...
$CE_{at}$ corresponds to fast intrinsic heart rate (i.e. when running). The pacemaker is pacing the ventricle after $AVI$ period %\hatodo{is it TAVI or AVI like in the previous seciton?}
