...
In this paper, we design domain-specific over-approximation rules that produce abstract models that not only cover explicitly modeled environment conditions, but also cover physiological timing behaviors and conditions not modeled in the set of initial models. 
