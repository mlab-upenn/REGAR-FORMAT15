...
During 2003-2012,  15\% of device recalls are because of software design failures, which is the most common cause for medical device recalls~\cite{recall_stats}.
