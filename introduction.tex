...
There are two categories of software bugs: 1) The software fails to conform to its design, or specifications; 2) The software design fail to improve the physiological conditions, which are specified in physiological requirements. Since the physiological requirements describe the intended behaviors of the closed-loop system consists of the environment and the system, evaluation of the physiological requirements requires closed-loop verification. 
