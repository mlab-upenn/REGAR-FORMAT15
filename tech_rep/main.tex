...
\setlength{\textheight}{20.2cm}
%\setlength{\oddsidemargin}{-.204in}

\setboolean{TECH_REPORT}{TRUE}

\title{Abstraction Trees for Closed-Loop Model Checking of Medical Devices\thanks{NSF CAREER 1253842, NSF MRI 1450342. This work was also supported by STARnet, a Semiconductor Research Corporation program, sponsored by MARCO and DARPA.}}
